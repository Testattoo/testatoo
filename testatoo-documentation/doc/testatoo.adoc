...
import static org.testatoo.core.Testatoo.*                  # <1>
import static org.testatoo.core.input.Keyboard.*            # <2>
import static org.testatoo.core.input.Mouse.*               # <3>
import static org.testatoo.core.property.Properties.*       # <4>
import static org.testatoo.core.state.States.*              # <5>
/**
 * @author davenante
 */
@RunWith(JUnit4)
