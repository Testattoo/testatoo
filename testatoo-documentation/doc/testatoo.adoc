...
Some interesting thing can be show in this test :
 ...
 . We work with Strongly typed components:: The brain of the computer.
...
Monitor:: Displays information in visual form using text and graphics.
 ...
 . - We work with Strongly typed components::fdsfdsfdsfdsfdsfdsfdsfds fdsfdsfdsfdsfds fsdfdsfsdfsd
