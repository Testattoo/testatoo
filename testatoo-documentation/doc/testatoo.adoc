...
We work with Strongly typed components:: As you can see Testatoo manipulate typed components like TextField, Button, ListView.
                                         The power of Testatoo

We work with deferred evaluation:: You can instantiate ListView also the component is not available in the page.
                                   You can also test that the component is missing.

The DSL is very clean and functional:: TODO
The code never refer to a technical layer:: Used to enter text or control items on the screen.
