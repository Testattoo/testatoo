...
States evaluations are applied thought the keywords *be* and *is*
...
* *is* is the imediate test of the state.
* *should* *be* is a defered evaluation a state.
...
[WARNING]
====
Finger / Pointer are not supported for the moment
====
