...
More seriously the main problems with UI tests come from the fact that there are always to technicals.
...
-------------------------------------------------------------------------------
.Note
NOTE: The complete sample is https://github.com/Ovea/testatoo-sample/tree/master/src/test/groovy/starter/[testatoo-sample].
