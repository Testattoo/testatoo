...
Testatoo is built on top of http://www.seleniumhq.org/[Selenium, role="external", window="_blank"], it can work with any browser supported by http://www.seleniumhq.org/about/platforms.jsp[Selenium, role="external", window="_blank"] (IE, Google-chrome, Firefox, ...).
