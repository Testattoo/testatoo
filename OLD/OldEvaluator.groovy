 ...
 */
class OldEvaluator implements Evaluator {
...
//    protected final List<KeyModifier> pressedKeyModifier = new ArrayList<KeyModifier>();
     ...
     */
    public OldEvaluator(String name, Selenium selenium) {
        this.name = name
        this.selenium = selenium
    }

    public Selenium getImplementation() { selenium }
